...
public class MachinePlayer extends Player {
    ...
    private final ShootingStrategy estrategiaDisparo;

    public MachinePlayer(String nickname, Board tableroPrincipal, ShootingStrategy estrategiaDisparo) {
        super(nickname, tableroPrincipal);
     ...
     */
    public Coordenada elegirObjetivo(Board tableroDelHumano) {
        return estrategiaDisparo.elegirDisparo(tableroDelHumano);
    }
}
